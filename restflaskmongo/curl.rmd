...
combine mongodb and pythin flask-restful
~~~~
curl -u jacob:password -i -H "Content-Type: application/json" -X POST -d " { \"name\" : \"test7\", \"distance\" : \"700\"} " http://localhost:5000/api/v1.0
curl -u jacob:password -i http://localhost:5000/api/v1.0
~~~~
